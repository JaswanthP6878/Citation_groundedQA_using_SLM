...
Conditions A--E are the committed core; F and G (both local) are stretch goals
...
Answer: Token F1 (QASPER official) and BERTScore (reference-free semantic similarity).
Faithfulness: RAGAS \citep{es2023ragas} with Llama-3-8B as the local
evaluator judge (served via Ollama), eliminating any external API dependency.
